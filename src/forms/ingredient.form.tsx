...
const IngredientForm = () => {
    ...
    const { addIngredient } = useIngredienteStore()
    ...
    const handleSubmit = async (formData: FormData) => {
        ...
        startTransition(async () => {
            ...
            const storeError = useIngredienteStore.getState().error
        ...
        <div className="flex gap-2 w-full">
            <div className="w-1/3">
                <Select
                    ...
                    {CATEGORY_OPTIONS.map((option) => (
                        <SelectItem key={option.value} className="text-black">{option.label}</SelectItem>
                    ))}
            ...
            <div className="w-1/3">
                <Input
                    ...
                    endContent={
                        <span className="absolute right-3 top-1/2 transform -translate-y-1/2">P</span>
                    }
                    validate={(value) => {
